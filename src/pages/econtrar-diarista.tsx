    ...
    <ScrollView>
      ...
      {buscaFeita &&
        (diaristas.length > 0 ? (
          <ResponseContainer>
            ...
            {diaristasRestantes > 0 && (
              <TextContainer>
                ...
                {diaristasRestantes > 1 ? 'profissionais atendem' : 'profissional atende'} ao seu
                endereço.
              </TextContainer>
            )}
          ...
          <TextContainer>Ainda não temos nenhuma diarista disponível em sua região</TextContainer>
        ))}
    </ScrollView>
  );
};
